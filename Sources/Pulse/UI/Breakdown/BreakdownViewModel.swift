...
final class BreakdownViewModel {
    ...
    var reloadKey: String { "\(selectedProvider.rawValue)|\(timeframe.rawValue)" }
    ...
    /// "signed in but nothing in this window".
    ...
    func load() async {
        ...
        var result = await environment.projectUsage.breakdown(for: selectedProvider, timeframe: timeframe)
